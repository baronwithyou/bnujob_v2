<ul class="nav nav-tabs business-nav" style="margin-top: 20px;">
    <li role="presentation" class="{{ url()->current() == route('business.all_jobs') ? 'active' : '' }}">
        <a href="{{ route('business.all_jobs') }}">所有兼职</a>
    </li>
    ...
    <li role="presentation" class="{{ Route::currentRouteName() == 'business.resume.check' ? 'active' : '' }}">
        <a href="{{ route('business.resume.check') }}">审批简历
